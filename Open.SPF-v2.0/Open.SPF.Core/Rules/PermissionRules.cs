...
namespace Open.SPF.Permissions
{
    public class PermissionRules : ICoreRulesContainer
    {
        ...
        public ICustomRuleContainer CustomRuleContainerFromTypeName(string typeName)
        {
            ...
            {
                Open.Common.Utility.TraceUtility.WriteInformationTrace(this.GetType(), "CustomRuleContainerFromTypeName", null, String.Format("Could not obtain Type information from the Type name. TypeName: {0}", typeName), Open.Common.Utility.TraceUtility.TraceType.Warning);
                return null;
            }
            ...
            {
                Open.Common.Utility.TraceUtility.WriteInformationTrace(this.GetType(), "CustomRuleContainerFromTypeName", null, String.Format("Could not obtain Contructor infomration about the Type. TypeName: {0}", typeName), Open.Common.Utility.TraceUtility.TraceType.Warning);
                return null;
            }
            ...
            {
                Open.Common.Utility.TraceUtility.WriteInformationTrace(this.GetType(), "CustomRuleContainerFromTypeName", null, String.Format("Could not obtain an instance of the Type from the constructor. TypeName: {0}", typeName), Open.Common.Utility.TraceUtility.TraceType.Warning);
            }
        ...
        public IsAuthorizedMethod RuleDelegateFromMethodName(ICustomRuleContainer customContainer, string methodName)
        {
            ...
            {
                Open.Common.Utility.TraceUtility.WriteInformationTrace(this.GetType(), "RuleDelegateFromMethodName", null, String.Format("Could not obtain Method information from the Method name. TypeName: {0}, MethodName: {1}", customContainer.GetType().FullName, methodName), Open.Common.Utility.TraceUtility.TraceType.Warning);
                return null;
            }
        ...
        public string RuleNameFromMethodName(ICustomRuleContainer customContainer, string methodName)
        {
            ...
            if (ruleMethodInfo == null)
            {
                Open.Common.Utility.TraceUtility.WriteInformationTrace(this.GetType(), "RuleNameFromMethodName", null, String.Format("Could not obtain Method information from the Method name. TypeName: {0}, MethodName: {1}", customContainer.GetType().FullName, methodName), Open.Common.Utility.TraceUtility.TraceType.Warning);
                return null;
            }
            ...
            if (permissionAttribute == null)
            {
                Open.Common.Utility.TraceUtility.WriteInformationTrace(this.GetType(), "RuleNameFromMethodName", null, String.Format("The {1} method in the {0} class was marked as a Permission Rule Method, but it exhibited an incorrect method signature for rule processing. A Permission Rule Method should accept the following parameters: (IIdentity userIdentity, IEnumerable<string> userRoles, Dictionary<string, object> contextPropertyBag).", customContainer.GetType().FullName, ruleMethodInfo.Name), Open.Common.Utility.TraceUtility.TraceType.Warning);
                return null;
            }
